<!-- <!DOCTYPE html>
    ...
    <body>
        ...
        <a class="navbar-brand" href="#"><img src='images/pepopoint.png' width="40%"></a>
...
<nav class="navbar navbar-expand-md navbar-light bg-light sticky-top">
    <div class="container-fluid">
        <a class="navbar-brand" href="home_admin.php"><img src="img/logo.png"></a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="checkProducts.php">Check Products</a>
                </li>
                <li class="nav-item">
